...
========================    =======   ========================
`.AES`         Block     Advanced Encryption Standard
`.ARC2`        Block     Alleged RC2
`.ARC4`        Stream    Alleged RC4
`.Blowfish`    Block     Blowfish
`.CAST`        Block     CAST
`.DES`         Block     The Data Encryption Standard.
                                      Very commonly used in the past,
                                      but today its 56-bit keys are too small.
`.DES3`        Block     Triple DES.
`.XOR`         Stream    The simple XOR cipher.
========================    =======   ========================
...
==========================    =======================
`.PKCS1_v1_5`    PKCS#1 v1.5 encryption, based on RSA key pairs
`.PKCS1_OAEP`    PKCS#1 OAEP encryption, based on RSA key pairs
==========================    =======================
