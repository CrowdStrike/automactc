"""A module intended to read and parse the utmpx file located in /private/var/run/utmpx.
...
def module():
    ...
    # This is a string version of the struct format, as described in the following:
