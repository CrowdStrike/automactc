...
from .common.functions import multiglob, read_bplist, read_stream_bplist
    ...
    for udir in user_inputdir:
        ...
        try:
            if sys.version_info[0] < 3:
                ...
                with open(windows[0], 'rb') as pl:
                    windows_plist = plistlib.load(pl)
            xmltype = True
        except ExpatError:
        ...
        for chunk in data_chunks:
            ...
            if available == blocksize:
                ...
                if NSWindowID not in windows_data.keys() or not windows_data[NSWindowID]:
